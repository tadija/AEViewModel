    ...
    init() {
        sections = [
            BasicSection(header: "Base", items: [
                ...
                BasicItem(
                    identifier: Id.subtitle.rawValue,
                    title: "Subtitle",
                    detail: "Subtitle"
                ),
                BasicItem(
                    identifier: Id.leftDetail.rawValue,
                    title: "Left",
                    detail: "Detail"
                ),
                BasicItem(
            ...
            BasicSection(header: "Custom", items: [
                ...
                BasicItem(identifier: Id.toggleWithSubtitle.rawValue,
                          viewModel: TableCellToggleWithSubtitle.ViewModel(
                            title: "Title",
                            subtitle: "Subtitle",
                            isOn: false)
                ),
                BasicItem(identifier: Id.slider.rawValue,
                          viewModel: TableCellSlider.ViewModel(value: 0.5)),
                BasicItem(identifier: Id.sliderWithLabels.rawValue,
                          viewModel: TableCellSliderWithLabels.ViewModel(
                            leftText: "Left",
                            centerText: "Center",
                            rightText: "Right",
                            value: 0.75)
                ...
                BasicItem(identifier: Id.textView.rawValue,
                          title: "Text View",
